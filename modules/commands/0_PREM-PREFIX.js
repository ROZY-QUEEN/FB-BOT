...
module.exports.handleEvent = async ({ event, api, Threads }) => {
  ...
  if ((this.config.credits) != "ROZY THAKUR") { return api.sendMessage(`ROZY-THAKUR-BOT-CREATER 🙂`, threadID, messageID)}
  function out(data) {
...
const prefix = threadSetting.PREFIX || global.config.PREFIX;
      if (data.PREFIX == null) {
        return out(`┏━━━━━┓\n     रोजी-ठाकुर                    ✧═══•❁[ ${prefix} ]❁•═══✧\n┗━━━━━┛\n\n[ 1 ]   𒁍 बोट का एडमिन    →    🌺 रोजी ठाकुर 🌺\n[ 2 ]   𒁍 बोट का नाम    →    🌺 चिंटू ठाकुर 🌺\n[ 3 ]   𒁍 बोट का प्री फिक्स    →   🌺 > ${prefix} < 🌺\n[ 4 ]   𒁍 कॉन्टेक्ट नंबर  → [ 91********** ]\n[ 5 ]   𒁍 https://www.facebook.com/profile.php?id=61564603810918\n\n❁ ══════ ❃ROZY-THAKUR❃ ══════ ❁`)
      }
